...
**Action:** Mine 10 Stone blocks  
**Expected:**
- Actionbar shows "+5 Mining XP" per block
...
**Priority:** HIGH  
**Setup:** Player with 95 Mining XP (Level 0)  
**Action:** Mine 1 Stone block (+5 XP)  
**Expected:**
- Title: "LEVEL UP! Mining → Level 1"
- Subtitle: "Keep grinding to unlock more bonuses!"
- `/skills` shows "Mining Lv 1 - 0/200 XP (0%)"
- Haste effect appears (Mining Speed stat bonus)
